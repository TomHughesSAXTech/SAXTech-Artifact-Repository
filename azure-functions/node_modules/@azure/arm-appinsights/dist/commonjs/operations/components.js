...
class ComponentsImpl {
     ...
     * @param options The options parameters.
     */
    purge(resourceGroupName, resourceName, body, options) {
        return this.client.sendOperationRequest({ resourceGroupName, resourceName, body, options }, purgeOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    getPurgeStatus(resourceGroupName, resourceName, purgeId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, resourceName, purgeId, options }, getPurgeStatusOperationSpec);
    }
    /**
     * ListNext
...
exports.ComponentsImpl = ComponentsImpl;
