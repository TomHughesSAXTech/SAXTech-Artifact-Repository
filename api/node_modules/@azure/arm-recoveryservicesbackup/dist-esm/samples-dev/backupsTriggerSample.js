...
function triggerBackup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resourceGroupName = process.env["RECOVERYSERVICESBACKUP_RESOURCE_GROUP"] || "linuxRsVaultRG";
        ...
        const result = yield client.backups.trigger(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=backupsTriggerSample.js.map