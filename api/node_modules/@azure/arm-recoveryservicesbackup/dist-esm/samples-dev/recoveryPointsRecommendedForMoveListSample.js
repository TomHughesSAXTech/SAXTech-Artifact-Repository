...
function getProtectedAzureVMRecoveryPointsRecommendedForMove() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resourceGroupName = process.env["RECOVERYSERVICESBACKUP_RESOURCE_GROUP"] || "rshhtestmdvmrg";
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.recoveryPointsRecommendedForMove.list(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, parameters)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    let item = _c;
...
//# sourceMappingURL=recoveryPointsRecommendedForMoveListSample.js.map