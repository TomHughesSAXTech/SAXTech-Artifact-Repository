...
function deleteProtectionFromAzureVirtualMachine() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.protectedItems.delete(vaultName, resourceGroupName, fabricName, containerName, protectedItemName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=protectedItemsDeleteSample.js.map