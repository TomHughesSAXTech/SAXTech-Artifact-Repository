...
import { ValidateOperationRequestUnion, ValidateOperationTriggerOptionalParams } from "../models";
/** Class containing ValidateOperation operations. */
export declare class ValidateOperationImpl implements ValidateOperation {
