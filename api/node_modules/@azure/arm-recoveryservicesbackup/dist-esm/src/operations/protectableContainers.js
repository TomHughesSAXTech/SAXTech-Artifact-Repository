...
export class ProtectableContainersImpl {
    /**
    ...
    listPagingPage(vaultName, resourceGroupName, fabricName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(vaultName, resourceGroupName, fabricName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(vaultName, resourceGroupName, fabricName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(vaultName, resourceGroupName, fabricName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(vaultName, resourceGroupName, fabricName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
...
//# sourceMappingURL=protectableContainers.js.map