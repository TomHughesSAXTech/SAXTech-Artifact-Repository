...
export class ResourceGuardProxiesImpl {
    /**
    ...
    getPagingPage(vaultName, resourceGroupName, options, settings) {
        return __asyncGenerator(this, arguments, function* getPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._get(vaultName, resourceGroupName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._getNext(vaultName, resourceGroupName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    getPagingAll(vaultName, resourceGroupName, options) {
        return __asyncGenerator(this, arguments, function* getPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.getPagingPage(vaultName, resourceGroupName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
...
//# sourceMappingURL=resourceGuardProxies.js.map